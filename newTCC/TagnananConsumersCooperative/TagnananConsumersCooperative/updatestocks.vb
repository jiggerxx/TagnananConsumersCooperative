Public Class updatestocks
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            With cmd
                .Connection = dbconn
                .CommandText = "UPDATE products SET stock='" & (stocks + Val(TextBox1.Text)) & "',srp='" & TextBox2.Text & "' WHERE prodname = '" & ComboBox1.Text & "'"
                .ExecuteNonQuery()
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            ...
            With cmd
                .Connection = dbconn
                .CommandText = " SELECT qty FROM products WHERE prodname ='" & ComboBox1.Text & "'"
                dr = cmd.ExecuteReader

                While dr.Read
                    stocks = Val(dr.Item("stock"))
                End While
