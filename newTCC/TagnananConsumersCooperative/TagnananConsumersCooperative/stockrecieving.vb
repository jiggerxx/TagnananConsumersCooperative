    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        For x As Integer = 0 To DataGridView1.RowCount - 1
            ...
            Try
                ...
                With cmd
                    .Connection = dbconn
                    .CommandText = "INSERT INTO acquired_products VALUES('" & ("SRR-" & txtSRR.Text) & "','" & DataGridView1.Rows(x).Cells(0).Value & "','" & DataGridView1.Rows(x).Cells(1).Value & "','" & DataGridView1.Rows(x).Cells(3).Value & "','" & DataGridView1.Rows(x).Cells(6).Value & "','" & qtyholder & "','" & DateTimePicker1.Value.ToString("yyyy/MM/dd HH:MM:ss") & "','" & DataGridView1.Rows(x).Cells(4).Value & "','0')"
                    .ExecuteNonQuery()
            ...
            If stocks = "0" Then
                ...
                Try
                    ...
                    With cmd
                        ...
                        .Connection = dbconn
                        .CommandText = "UPDATE products SET stock='" & stocks & "', srp = '" & DataGridView1.Rows(x).Cells(6).Value & "' WHERE prodcode='" & DataGridView1.Rows(x).Cells(0).Value & "'"
                        .ExecuteNonQuery()
                    End With
                Catch ex As Exception
                    MessageBox.Show("Error!" + ex.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ...
                Try
                    ...
                    With cmd
                        ...
                        .Connection = dbconn
                        .CommandText = "UPDATE acquired_products SET status='1' WHERE prodcode='" & DataGridView1.Rows(x).Cells(0).Value & "'"
                        .ExecuteNonQuery()
                    End With
                Catch ex As Exception
                    MessageBox.Show("Error!" + ex.Message, "", MessageBoxButtons.OK, MessageBoxIcon.Error)
