...
Public Class printbyrange6
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim rptDoc As CrystalDecisions.CrystalReports.Engine.ReportDocument = New cashsalesreportlistalldept
            ...
            Try
                ...
                With cmd
                    .Connection = dbconn
                    .CommandText = "SELECT FORMAT(SUM(resibo.finaltotal),2) as 'gtotal' FROM department LEFT JOIN customers ON customers.department = department.dept_name LEFT JOIN resibo ON customers.custcode = resibo.custcode  WHERE resibo.payment_type = 'CASH' AND resibo.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "'"
            ...
            Try
                ...
                query = "SELECT customers.department,FORMAT(SUM(resibo.finaltotal),2) as gtotal FROM department LEFT JOIN customers ON customers.department = department.dept_name LEFT JOIN resibo ON customers.custcode = resibo.custcode  WHERE resibo.payment_type = 'CASH' AND resibo.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "' GROUP BY department.dept_name "
                ...
                dbconn.Close()
            Catch ex As Exception
                MessageBox.Show(ex.Message + "cashsalesreportlistalldept")
            End Try
