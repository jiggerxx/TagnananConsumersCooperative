...
Public Class printbyrange5
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim rptDoc As CrystalDecisions.CrystalReports.Engine.ReportDocument = New cashsalesreportlist
            ...
            Try
                ...
                With cmd
                    .Connection = dbconn
                    .CommandText = "SELECT FORMAT(SUM(resibo.finaltotal),2) as 'gtotal' FROM resibo LEFT JOIN customers ON resibo.custcode = customers.custcode WHERE resibo.payment_type = 'CASH' AND customers.department = '" & ComboBox1.Text & "' AND resibo.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "'"
            ...
            Try
                ...
                query = "SELECT CONCAT(customers.lname,', ',customers.fname) as 'custname', FORMAT(SUM(resibo.finaltotal),2) as 'gtotal' FROM resibo LEFT JOIN customers ON resibo.custcode = customers.custcode WHERE resibo.payment_type = 'CASH' AND customers.department = '" & ComboBox1.Text & "' AND resibo.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "' GROUP BY custname "
                ...
                dbconn.Close()
            Catch ex As Exception
                MessageBox.Show(ex.Message + "cashsalesreportlist")
            End Try
