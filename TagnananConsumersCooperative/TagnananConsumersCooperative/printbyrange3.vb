...
Public Class printbyrange3
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim query As String
            Dim creditsalesreportlist As New DataSet
            Dim rptDoc As CrystalDecisions.CrystalReports.Engine.ReportDocument = New creditsalesreportlist
            ...
            Dim dept As CrystalDecisions.CrystalReports.Engine.TextObject
            ...
            dept = rptDoc.ReportDefinition.ReportObjects("Text13")
            ...
            Try
                ...
                With cmd
                    .Connection = dbconn
                    .CommandText = "SELECT FORMAT(SUM(customer_utangs.balance),2) as 'gtotal' FROM customer_utangs LEFT JOIN customers ON customer_utangs.custcode = customers.custcode WHERE customers.department = '" & ComboBox1.Text & "' AND customer_utangs.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "'"
            ...
            Try
                ...
                query = "SELECT CONCAT(customers.lname,', ',customers.fname) as 'custname', FORMAT(SUM(customer_utangs.balance),2) as 'gtotal' FROM customer_utangs LEFT JOIN customers ON customer_utangs.custcode = customers.custcode WHERE customers.department = '" & ComboBox1.Text & "' AND customer_utangs.transacdate BETWEEN '" & selecteddate & "' AND '" & selecteddate2 & "' GROUP BY customer_utangs.custcode "
                adapt = New MySqlDataAdapter(query, dbconn)
                adapt.Fill(creditsalesreportlist, "creditsalesreportlist")

                rptDoc.SetDataSource(creditsalesreportlist)
                dbconn.Close()
            Catch ex As Exception
                MessageBox.Show(ex.Message + "creditsalesreportlist")
            End Try
