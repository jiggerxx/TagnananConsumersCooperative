...
Public Class physicalprodcount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TagnananConsumersCooperative.physicalprodcount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedphysicalprodcount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As physicalprodcount = New physicalprodcount()
        rpt.Site = Me.Site
        Return rpt
    End Function
